# NEXUS-Backend
Backend for OG Fortnite projects | Free To Use. | Read README

Backend made with ❤️ by M4RCO
(Official backend was made by Burlone, This is a modded backend, all main backend credits to Lawin and Burlone)

![Imgur](https://i.imgur.com/ImIwpRm.png)

NEXUS Backend is a universal Fortnite private server backend written in [JavaScript](https://en.wikipedia.org/wiki/JavaScript)
...
2) **Download** and **Extract** NEXUS Backend to a safe location.
...
## Credits
Credits have been moved to the **Contributors** section of github. If I forgot to include someone, write to **marco.fnbr** on Discord

---

**NEXUS Backend** is under continuous development and there could be errors of any kind, if you want to give advice on what to add and how to improve the project or report any errors you can do so by writing to **marco.fnbr** on Discord
